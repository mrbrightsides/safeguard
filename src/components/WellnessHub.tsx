    ...
    <div className="w-full min-w-0 space-y-6 sm:space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="lg:col-span-2 relative min-h-[220px] sm:min-h-[256px] rounded-[28px] sm:rounded-[40px] overflow-hidden bg-teal-900 text-white p-6 sm:p-8 md:p-12 flex flex-col justify-center">
          <div className="absolute top-0 right-0 p-6 sm:p-12 opacity-20 pointer-events-none">
            <Sparkles className="w-32 h-32 sm:w-48 sm:h-48" />
          </div>
          <div className="relative z-10 max-w-lg">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-4 tracking-tight">Your SafeSpace</h2>
            <p className="text-teal-100/70 text-sm sm:text-base md:text-lg">
        ...
        <div 
          ...
          className="relative min-h-[220px] sm:min-h-[256px] rounded-[28px] sm:rounded-[40px] overflow-hidden bg-teal-600 text-white p-6 sm:p-8 flex flex-col justify-between cursor-pointer group hover:bg-teal-700 transition-all shadow-xl shadow-teal-600/20"
        >
          <div className="absolute -top-4 -right-4 p-6 sm:p-8 opacity-20 group-hover:scale-110 transition-transform pointer-events-none">
            <Bot className="w-24 h-24 sm:w-32 sm:h-32" />
          </div>
          <div className="relative z-10">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-4">
              <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <h3 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">AI Counselor</h3>
          ...
          <div className="relative z-10 flex items-center gap-2 text-[10px] sm:text-xs font-bold uppercase tracking-widest mt-3 sm:mt-0">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 w-full flex-1 md:justify-end no-scrollbar min-w-0">
          {categories.map(cat => (
            <button
              ...
              className={cn(
                "px-4 sm:px-6 py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-xs font-bold transition-all whitespace-nowrap shrink-0",
                activeCategory === cat 
            ...
            >
              <div className="relative h-40 sm:h-48 shrink-0">
                ...
                <div className="absolute top-3 left-3 sm:top-4 sm:left-4">
                  <span className="px-2 py-0.5 sm:px-3 sm:py-1 bg-white/90 backdrop-blur-md rounded-full text-[9px] sm:text-[10px] font-bold uppercase tracking-widest">
                    {resource.category}
                  </span>
                </div>
                <div 
              ...
              <div className="p-4 sm:p-6 flex flex-col flex-1">
                <div className="flex items-center gap-2 text-[9px] sm:text-[10px] font-mono text-gray-400 uppercase tracking-widest mb-2">
                  <Clock className="w-3 h-3" />
                  {resource.duration}
                </div>
                <h3 className="font-bold text-gray-900 mb-2 group-hover:text-teal-600 transition-colors line-clamp-1 text-sm sm:text-base">
                  {resource.title}
                </h3>
                <p className="text-[11px] sm:text-xs text-gray-500 line-clamp-2 mb-4 flex-1">
