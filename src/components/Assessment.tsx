...
import { ChevronRight, ChevronLeft, CheckCircle2, AlertCircle, Volume2, VolumeX } from 'lucide-react';
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-emerald-600 font-bold uppercase tracking-tighter">AI-Driven Branching Active</span>
          </div>
          <div className="flex items-center gap-4">
            <button 
              ...
              className={cn(
                ...
                isTtsEnabled ? "bg-black text-white" : "bg-gray-100 text-gray-400 hover:bg-gray-200"
              )}
